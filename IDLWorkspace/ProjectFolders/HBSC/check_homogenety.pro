...
FUNCTION CHECK_HOMOGENETY, Image, ptrBlocks, alpha
   ...
   FOR i = 0L, N_ELEMENTS(ptrBlocks)-1 DO BEGIN
      ...
      ParFocus = GET_PARAMETERS_FROM_BLOCK(Image, focus)
      ...
      FOR j = 0L, N_ELEMENTS(regions)-1 DO BEGIN
         ...
         ParReg = GET_PARAMETERS_FROM_BLOCK(Image, reg)

         dis = BHATTACHARYYA(ParFocus.Mu, ParReg.Mu, ParFocus.Sigma, ParReg.Sigma)
